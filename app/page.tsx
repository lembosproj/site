      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-8 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              ...
              <div className="flex items-center justify-center mt-8 lg:mt-0">
                <div className="relative w-full overflow-hidden rounded-lg border bg-background p-2 shadow-lg">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-burst text-white">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Ready to streamline software delivery?</h2>
